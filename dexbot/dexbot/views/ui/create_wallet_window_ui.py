...
# Form implementation generated from reading ui file '/Users/jacko/Desktop/DEXBot/dexbot/dexbot/views/ui/create_wallet_window.ui'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setTabOrder(self.password_input, self.confirm_password_input)
        Dialog.setTabOrder(self.confirm_password_input, self.ok_button)

    def retranslateUi(self, Dialog):
        _translate = QtCore.QCoreApplication.translate
        Dialog.setWindowTitle(_translate("Dialog", "Create wallet"))
        self.helper_text.setText(_translate("Dialog", "Before you can start using DEXBot, you need to create an uptick wallet."))
        self.label.setText(_translate("Dialog", "The Uptick Wallet password is used to encrypt your BitShares account private keys."))
